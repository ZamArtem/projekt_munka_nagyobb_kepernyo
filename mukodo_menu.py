...
def options(ball):
    ...
    easy_button   = button.Button(220, 10, easy_img, 0.8)
    normal_button = button.Button(180, 134, normal_img, 0.8)
    hard_button   = button.Button(230, 249, hard_img, 0.8)
    back_button   = button.Button(227, 389, back_img, 0.8)       
...
def jatek(ball):
    ...
    #------------------------------------------------------------------------------------------
        ...
        screen.fill(BLACK)
        # Draw the net
        pygame.draw.line(screen, WHITE, [349, 0], [349, 541], 5)
        ...
        cv2.line(flipped,(490,800),(490,0),(0,0,0),10)
